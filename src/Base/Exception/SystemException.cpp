...
{
    SystemException::SystemException(const std::string &context, const std::source_location &sourceLocation) : SystemException(context, lastErrnoErrorCode(), sourceLocation)
    {
    ...
    SystemException::SystemException(const std::string &context, std::error_code errorCode, const std::source_location &sourceLocation) :
        Exception(context + ": [" + std::to_string(errorCode.value()) + "] " + errorCode.message(), sourceLocation), m_errorCode(errorCode)
    {
    }
