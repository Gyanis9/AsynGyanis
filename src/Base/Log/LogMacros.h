...
/// 使用默认根日志器的格式化宏
#define LOG_TRACE_FMT(format_string, ...)                                                                                                                                          \
    LOG_FORMAT_INTERNAL(AsynGyanis::Base::LoggerRegistry::instance().getRootLogger(), AsynGyanis::Base::LogLevel::Trace, format_string, ##__VA_ARGS__)
#define LOG_DEBUG_FMT(format_string, ...)                                                                                                                                          \
    LOG_FORMAT_INTERNAL(AsynGyanis::Base::LoggerRegistry::instance().getRootLogger(), AsynGyanis::Base::LogLevel::Debug, format_string, ##__VA_ARGS__)
#define LOG_INFO_FMT(format_string, ...)                                                                                                                                           \
    LOG_FORMAT_INTERNAL(AsynGyanis::Base::LoggerRegistry::instance().getRootLogger(), AsynGyanis::Base::LogLevel::Info, format_string, ##__VA_ARGS__)
#define LOG_WARN_FMT(format_string, ...)                                                                                                                                           \
    LOG_FORMAT_INTERNAL(AsynGyanis::Base::LoggerRegistry::instance().getRootLogger(), AsynGyanis::Base::LogLevel::Warn, format_string, ##__VA_ARGS__)
#define LOG_ERROR_FMT(format_string, ...)                                                                                                                                          \
    LOG_FORMAT_INTERNAL(AsynGyanis::Base::LoggerRegistry::instance().getRootLogger(), AsynGyanis::Base::LogLevel::Error, format_string, ##__VA_ARGS__)
#define LOG_FATAL_FMT(format_string, ...)                                                                                                                                          \
    LOG_FORMAT_INTERNAL(AsynGyanis::Base::LoggerRegistry::instance().getRootLogger(), AsynGyanis::Base::LogLevel::Fatal, format_string, ##__VA_ARGS__)
...
#define LOG_ERROR_EXCEPTION(exception, format_string, ...)                                                                                                                         \
    LOG_EXCEPTION_INTERNAL(AsynGyanis::Base::LoggerRegistry::instance().getRootLogger(), AsynGyanis::Base::LogLevel::Error, exception, format_string, ##__VA_ARGS__)
