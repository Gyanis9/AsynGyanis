...
namespace AsynGyanis::Net
{
    ...
    {
        // ====================================================================
        // 序列化预留量：全部由 constexpr 常量按报文结构推导，取代旧实现里的
        // 48 / 28 / 38 / 4 这类无出处魔法数字。预留只是容量提示，估少了
        // std::string 会自行扩容，不影响正确性，只影响分配次数
        // ====================================================================
         ...
         * @details 缓冲长度按整数类型推导，杜绝旧实现「8 字节栈数组配 int」的写穿风险；
