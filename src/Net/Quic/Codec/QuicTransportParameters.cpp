    ...
    namespace
    {
        ...
        constexpr IntegerParameterBinding kIntegerParameters[] = {
                ...
                {kIdInitialMaximumBidirectionalStreams, "initial_max_streams_bidi",
                 &QuicTransportParameters::initialMaximumBidirectionalStreams, 0, kQuicMaximumIntegerValue},
                {kIdInitialMaximumUnidirectionalStreams, "initial_max_streams_uni",
                 &QuicTransportParameters::initialMaximumUnidirectionalStreams, 0, kQuicMaximumIntegerValue},
